...
class AboutHashes < Neo::Koan
  ...
  def test_default_value
    ...
    # Hash.new set default value. You get default value, when get value of the undefined keys.
  ...
  def test_default_value_is_the_same_object
    ...
    # "<<" method has the function to add other element to default value.
    hash[:one] << "uno"
    hash[:two] << "dos"
  ...
  def test_default_value_with_block
    ...
    # "<<" method change the function to add key and value, when defining default key and value.
    hash[:one] << "uno"
    hash[:two] << "dos"
